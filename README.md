...
- [Cirklon tl;dr](#cirklon-tldr)
  ...
  - [Track page](#track-page)
    - [Assign an instrument](#assign-an-instrument)
    - [Delete an instrument](#delete-an-instrument)
    - [Mute a track](#mute-a-track)
    - [Arm a muted track](#arm-a-muted-track)
    - [Edit instrument associated to a track](#edit-instrument-associated-to-a-track)
    - [Delete an instrument](#delete-an-instrument)
    - [Create /list patterns](#create-list-patterns)
  - [Pattern page](#pattern-page)
    - [Pattern types](#pattern-types)
      - [P3 patterns](#p3-patterns)
      - [CK pattern](#ck-pattern)
    - [Pattern edit](#pattern-edit)
    - [Set pattern length](#set-pattern-length)
    - [Pattern pan](#pattern-pan)
    - [Bar follow](#bar-follow)
    - [Bar copy](#bar-copy)
    - [Bar Extend and Copy](#bar-extend-and-copy)
    - [Set last step](#set-last-step)
    - [Bar edit](#bar-edit)
    - [Bar loops](#bar-loops)
    - [Steps copy / insert](#steps-copy-insert)
    - [Fill patterns](#fill-patterns)
      - [Display fill options](#display-fill-options)
  - [Scene page](#scene-page)
    - [Scene page description](#scene-page-description)
      - [Gbar](#gbar)
      - [Leng(th)](#length)
      - [Song Adv(ance)](#song-advance)
      - [FTS (Force To Scale)](#fts-force-to-scale)
      - [Xpose](#xpose)
    - [Saving a scene](#saving-a-scene)
    - [Mute hold](#mute-hold)
    - [Scene list](#scene-list)
      - [Scene move](#scene-move)
      - [Scene loops](#scene-loops)
      - [Recall / Copy To Workscene](#recall-copy-to-workscene)
      - [Delete a scene](#delete-a-scene)
  - [Sculpting and randomizing](#sculpting-and-randomizing)
    - [Enable sculpt](#enable-sculpt)
    - [Sculpt modes](#sculpt-modes)
  - [Configuring the Aux Rows](#configuring-the-aux-rows)
  - [CK patterns](#ck-patterns)
    - [Gang](#gang)
    - [Slope](#slope)
    - [Fill patern](#fill-patern)
      - [Show fill-in options](#show-fill-in-options)
        - [Fill release options](#fill-release-options)
  - [Navigation](#navigation)
    - [Switch current track](#switch-current-track)
  - [Naming things](#naming-things)
  - [Global configuration](#global-configuration)
    - [Tempo](#tempo)
    - [Using more than 16 tracks](#using-more-than-16-tracks)
  - [Other](#other)
    - [Audition](#audition)
